...
<h3 align="center">I'm a blockchain enthusiast and work on Web3, ethers, Solidity, and Rust to build Dapps and write Smart Contracts.</h3>
<h3 align="center">I'm also a Generative AI enthusiast and actively building POCs for ChatBots using OpenAI, Chainlit, Streamlit, and AWS Sagemaker. Some of the LLM models that I worked on are GPT-3.5, GPT-4, and Llama. I used Anthropic Foundation Models available from AWS Bedrock.</h3>
